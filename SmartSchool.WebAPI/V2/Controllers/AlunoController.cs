...
namespace SmartSchool.WebAPI.V2.Controllers
{
    ...
    public class AlunoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByIdAsync(int id)
        {
         ...
         /// <summary>
        /// Método responsável por registrar nova disciplinapara um aluno especifico, trazendo tambem o professor no front da Versão 02.
        /// </summary>
        /// <returns></returns>
         [HttpPost("AlunosDisciplina")]
        public ActionResult Post(AlunoDisciplina alunoDisciplinal)
        {
        ...
        public async Task<IActionResult> Put(int id, AlunoRegistrarDto model)
        {
          ...
          /// <summary>
        ///  Método Responsalvel por trocr o estado de ativo para inativo ou vice-versa, do aluno Versão 02.
        /// </summary>
        /// <param name="id"></param>
